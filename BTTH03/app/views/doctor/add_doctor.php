...
<body>
    ...
    <section>
        <div class="m-5 text-center">
            <div class="mx-5">
                <form action="?controller=doctor&action=process_add" method="post">
                    <h2 class="mb-4">THÊM MỚI BÁC SỸ</h2>
                    <div class="input-group flex-nowrap mb-3">
                        <span class="input-group-text ms-5" id="addon-wrapping">Tên bác sỹ</span>
                        <input type="text" class="form-control me-5" aria-label="nameDoctor" aria-describedby="addon-wrapping" name="nameDoctor">
                    </div>
                    <div class="input-group flex-nowrap mb-3">
                        <span class="input-group-text ms-5" id="addon-wrapping">Chuyên khoa</span>
                        <input type="text" class="form-control me-5" aria-label="department" aria-describedby="addon-wrapping" name="department">
                    </div>
