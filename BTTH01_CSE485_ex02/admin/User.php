                        ...
                        ?>
                            <tr>
                                ...
                                <td style="font-size: 12px">
                                    <a style="padding: 1px 3px" href="detail_user.php?id=<?= $user['0'] ?>" class="btn btn-secondary"><i class="fa-solid fa-shield-halved" style="font-size: 16px;"></i></a>
                                </td>
                                <td style="font-size: 12px">
                                    <a style="padding: 1px 3px" href="edit_user.php?id=<?= $user['0'] ?>" class="btn btn-primary"><i class="fa-solid fa-pen" style="font-size: 16px;"></i></a>
                                </td>
